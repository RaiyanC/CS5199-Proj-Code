...
contract := function(digraph, options)
    ...
    edgeList, outNeigbours, idx, w, weights, randomEdgeIdx, cuts, edgesCut, parent, x, y, rank, opts, default, name;
...
KargerSteiner := function(digraph, probability)
    local digraphVertices, nrVertices, nrEdges, i, upperBound, edgesCut, cutInfo,
    ...
    analysisPath := Concatenation("../Maximal Flow Algorithms/Analysis/",
                    Concatenation(String(probability), "/kgs.csv"));
