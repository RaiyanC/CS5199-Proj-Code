Dijkstra := function(digraph, source, probability)
...
edgeInfo, distance, i, d, analysisPath, headers, nrEdges, startTime, endTime, data;
    ...
    analysisPath := Concatenation("../Shortest Path Algorithms/Analysis/",
                    Concatenation(String(probability), "/d.csv"));
